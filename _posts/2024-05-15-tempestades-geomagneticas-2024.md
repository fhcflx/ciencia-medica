...
Em maio de 2024, a Terra foi atingida por uma série de intensas tempestades geomagnéticas {% include geomag-tempestade-pt.html %} desencadeadas por poderosas ejeções de massa coronal (EMC) {% include geomag-cme-pt.html %} do Sol. Essas tempestades produziram auroras {% include geomag-aurora-pt.html %} visíveis em latitudes excepcionalmente baixas, incluindo partes dos Estados Unidos, Brasil, Europa e até [Norte da África][arabiaweather].   <!--more-->
O fenômeno foi amplamente documentado por observadores e cientistas, marcando um dos eventos de clima espacial mais significativos do século XXI.

Entre os dias 8 e 14 de maio de 2024, uma região ativa{% include ativa.html %} do Sol, a AR3664, deu origem a uma série de intensas erupções solares{% include geomag-erupcao-pt.html %} e EMC. Como resultado da elevada densidade e velocidade do vento solar{% include geomag-vento.html %}, e do campo magnético interplanetário{% include geomag-cinter.html %} atingindo valores extremos, além da interação das EMC com o campo geomagnético{% include geomag.html %}, ocorreu uma tempestade geomagnética intensa.
...
*Aurora vista em Pawleys Island, Carolina do Sul, EUA (33°N GLAT, 43°N MLAT), 11 de maio de 2024. Fonte: [Wikipedia][wiki]*

![Aurora em Quillón, Chile, 11 de maio de 2024](https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Aurora_austral.jpg/960px-Aurora_austral.jpg)
*Aurora vista em Quillón, Chile (36°S GLAT, 24°S MLAT), 11 de maio de 2024. Fonte: [Wikipedia][wiki]*
...
*Aurora vista em Melbourne, Austrália (38°S GLAT, 48°S MLAT) e em Cwmbran, País de Gales, Reino Unido (51°N GLAT, 47°N MLAT), 11 de maio de 2024. Fonte: [Wikipedia][wiki]*
...
As tempestades de maio de 2024 foram classificadas como [G5](#programas-de-alerta-de-clima-espacial) (extrema) pelo NOAA SWPC, com índices [Kp](#programas-de-alerta-de-clima-espacial) {% include geomag-kp-pt.html %} chegando a 9. Para comparação:
...
| Tempestades de Halloween| 2003| 9   | Satélites, GPS, aviação afetados               |
| Maio de 2024         | 2024| 9      | Auroras em baixas latitudes, falhas elétricas  |
| Tempestade de março  | 1989| 9      | Falhas em redes elétricas, auroras             |
| Tempestade de maio   | 1921| 9      | Falhas em comunicações, incêndios              |
| Tempestade de agosto | 1972| 8-9    | Satélites, comunicações afetadas               |
...
*Desenho das manchas solares por Richard Carrington, 1859. Fonte: [Wikipedia][carrington]*
...
Richard Christopher Carrington (1826–1875) foi um astrônomo inglês pioneiro que fez contribuições significativas à física solar. Suas observações em 1859 forneceram a primeira evidência de uma conexão direta entre atividade solar e tempestades geomagnéticas na Terra.
...
![Apagão de Quebec, 13 de março de 1989](https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/ExtremeEvent_19890310-00h_19890315-24h.jpg/960px-ExtremeEvent_19890310-00h_19890315-24h.jpg)
*GOES-7 monitorando as condições do clima espacial durante a grande tempestade geomagnética de março de 1989. O monitor de nêutrons de Moscou registrou a passagem de uma CME como uma queda nos níveis conhecida como Forbush decrease. Fonte: [Wikipedia][quebec]*
...
**NOAA Space Weather Prediction Center (SWPC, EUA):** Principal [agência][swpc] dos EUA para previsão, monitoramento e alertas de clima espacial. Fornece dados em tempo real, avisos e recursos educativos.

**ESA Space Weather Office (Europa):** A [Agência][esaswo] Espacial Europeia coordena o monitoramento e a pesquisa em clima espacial no continente.

**UK Met Office Space Weather Operations Centre (Reino Unido):** [Fornece][moswoc] previsões e alertas para o Reino Unido e colabora internacionalmente.

**National Institute of Information and Communications Technology (NICT) - Japão:** [Monitora][nictswc] atividade solar e geomagnética no Leste Asiático.

**Outras agências:** Canadá, [Brasil][embrace], Rússia, China, Austrália e mais 14 países também mantêm programas de clima espacial.

Essas agências compartilham dados e colaboram por meio do International Space Environment Service ([ISES][ises]), uma rede global para troca de informações sobre clima espacial.
...
|---------|-----------|----|-----------------|
| G1      | Menor     | 5  | Flutuações fracas na rede elétrica, impacto menor em satélites, auroras em altas latitudes |
| G2      | Moderada  | 6  | Possíveis alarmes de tensão, danos em transformadores em altas latitudes, auroras em latitudes médias |
| G3      | Forte     | 7  | Correções de tensão necessárias, alarmes falsos em dispositivos de proteção, auroras até o sul do Brasil/EUA |
| G4      | Severa    | 8  | Problemas generalizados de controle de tensão, possíveis danos a transformadores, auroras até o sul do Brasil/Europa |
| G5      | Extrema   | 9  | Problemas generalizados na rede elétrica, possível colapso do sistema, auroras vistas em regiões tropicais |
...
- [Wikipedia: Tempestades geomagnéticas de maio de 2024][wiki]
- [NOAA SWPC - Tempestade geomagnética extrema][noaa1]
- [NOAA SWPC - Escalas de Clima Espacial][noaa2]
...
[esaswo]: https://www.esa.int/Space_Safety/Space_weather/Space_Weather_Office
[swpc]: https://www.swpc.noaa.gov/
[moswoc]: https://weather.metoffice.gov.uk/learn-about/space-weather
[nictswc]: https://swc.nict.go.jp/en/
