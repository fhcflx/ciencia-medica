...
Between May 8 and 14, 2024, an active region{% include ativa-en.html %} of the Sun, AR3664, produced a series of intense solar flares{% include geomag-flare-en.html %} and CMEs. As a result of the high density and speed of the solar wind{% include geomag-vento-en.html %}, and the interplanetary magnetic field{% include geomag-cinter-en.html %} reaching extreme values, along with the interaction of the CMEs with the geomagnetic field{% include geomag-en.html %}, an intense geomagnetic storm occurred.
...
![Aurora in Quillón, Chile, May 11, 2024](https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Aurora_austral.jpg/960px-Aurora_austral.jpg)
...
![Aurora in Algeria, May 11, 2024]({{ site.baseurl }}/assets/img/aurora-algeria-24.png)
...
*Aurora seen in Melbourne, Australia (38°S GLAT, 48°S MLAT), and in Cwmbran, Wales, U.K. (51°N GLAT, 47°N MLAT), May 11, 2024. Source: [Wikipedia][wiki]*
...
The May 2024 storms were classified as [G5](#space-weather-alert-programs) (extreme) by NOAA SWPC, with [Kp](#space-weather-alert-programs) {% include geomag-kp-en.html %} indices reaching 9. For comparison:
...
**NOAA Space Weather Prediction Center (SWPC, USA):** The main [agency][swpc] in the US for space weather forecasting, monitoring, and alerts. Provides real-time data, warnings, and educational resources.

**ESA Space Weather Office (Europe):** The [European Space Agency][esaswo] coordinates space weather monitoring and research across Europe.

**UK Met Office Space Weather Operations Centre (UK):** [Provides][moswoc] forecasts and alerts for the UK and collaborates internationally.

**National Institute of Information and Communications Technology (NICT) - Japan:** [Monitors][nictswc] solar and geomagnetic activity in East Asia.

**Other agencies:** Canada, [Brazil][embrace], Russia, China, Australia, and 14 other countries also maintain space weather programs.

These agencies share data and collaborate through the International Space Environment Service ([ISES][ises]), a global network for space weather information exchange.
